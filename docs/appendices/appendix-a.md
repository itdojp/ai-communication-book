...
- canonicalな運用原則: <a href="{{ '/introduction/agent-protocol/' | relative_url }}">AIエージェント協働の実務SOP</a>
- 成果物の完成形: <a href="{{ '/appendices/appendix-c/' | relative_url }}">付録C</a>
- 会話から成果物への流れ: <a href="{{ '/appendices/appendix-d/' | relative_url }}">付録D</a>

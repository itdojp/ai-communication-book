...
Job Spec を作成したら、AIに渡す前に次の項目を確認する。

- [ ] Intent: 目的、利用者、成果物の用途が明確である。
- [ ] Context Boundary: 入力してよい情報と入力してはいけない情報を分けている。
- [ ] Output Contract: 出力形式、粒度、禁止事項が明確である。
- [ ] Acceptance Check: 採用条件、失敗条件、レビュー観点が書かれている。
- [ ] Verification: 一次情報、テスト、再現手順、人間レビューのどれで裏取りするかを決めている。
- [ ] Owner: 採否判断者、承認者、エスカレーション先が明確である。
